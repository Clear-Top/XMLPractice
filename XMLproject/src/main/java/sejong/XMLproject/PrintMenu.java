...
public class PrintMenu extends JFrame {
	...
	private static JButton jtreeBtn = new JButton("JTree로 보기");
...
//		}
		...
		doc = mainMenu.doc;
		jtreeBtn.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				PrintJTree jtree = new PrintJTree(doc);
				jtree.makeFrame();
			}
		});
		panelSouth.add(cancelBtn);
		panelSouth.add(jtreeBtn);
